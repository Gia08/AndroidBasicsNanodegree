...
public class FoodListFragment extends ListFragment {
    ...
    private Callback callback = FoodCallback;
    ...
    /**
     * A Food no-op implementation of the Callback interface. Only used when no active Activity is present.
     */
    private static final Callback FoodCallback = new Callback() {
        @Override
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        callback.onItemSelected(FoodContent.ITEMS.get(position).id);
    }
    ...
    private class MyListAdapter extends BaseAdapter {
        ...
        @Override
        public int getCount() {
            return FoodContent.ITEMS.size();
        }

        @Override
        public Object getItem(int position) {
            return FoodContent.ITEMS.get(position);
        }

        @Override
        public long getItemId(int position) {
            return FoodContent.ITEMS.get(position).id.hashCode();
        }
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            final FoodContent.FoodItem item = (FoodContent.FoodItem) getItem(position);
