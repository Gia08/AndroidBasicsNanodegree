...
public class PlaceListFragment extends ListFragment {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        callback.onItemSelected(PlacesContent.ITEMS.get(position).id);
    }
    ...
    private class MyListAdapter extends BaseAdapter {
        ...
        @Override
        public int getCount() {
            return PlacesContent.ITEMS.size();
        }

        @Override
        public Object getItem(int position) {
            return PlacesContent.ITEMS.get(position);
        }

        @Override
        public long getItemId(int position) {
            return PlacesContent.ITEMS.get(position).id.hashCode();
        }
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            final PlacesContent.PlaceItem item = (PlacesContent.PlaceItem) getItem(position);
