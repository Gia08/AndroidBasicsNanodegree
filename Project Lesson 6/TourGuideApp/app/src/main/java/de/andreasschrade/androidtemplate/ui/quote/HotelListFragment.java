...
public class HotelListFragment extends ListFragment {
    ...
    private Callback callback = hotelCallback;
    ...
    /**
     * A Hotel no-op implementation of the Callback interface. Only used when no active Activity is present.
     */
    private static final Callback hotelCallback = new Callback() {
        @Override
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        callback.onItemSelected(HotelContent.ITEMS.get(position).id);
    }
    ...
    private class MyListAdapter extends BaseAdapter {
        ...
        @Override
        public int getCount() {
            return HotelContent.ITEMS.size();
        }

        @Override
        public Object getItem(int position) {
            return HotelContent.ITEMS.get(position);
        }

        @Override
        public long getItemId(int position) {
            return HotelContent.ITEMS.get(position).id.hashCode();
        }
